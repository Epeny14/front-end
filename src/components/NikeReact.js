...
import Img79 from '../img/Nike V2.png';
...
import Img84 from '../img/Flickr - Nike - 13.jpg';
import Img85 from '../img/Flickr - Nike - 12.jpg';
import Img86 from '../img/Flickr - Nike - 11.jpg';
import '../styles/nike-react.css';
            ...
            <div className='section-description'>
                <div className='flex-11'>
                    ...
                    <div className='description-1'>
                        <h1 className='title-description-11'>Nike React V2</h1>
                        <p className='price-tag-50'>45,00 €</p>
