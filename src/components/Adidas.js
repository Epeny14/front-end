            ...
            <div className='section-description'>
                <div className='flex-11'>
                    ...
                    <div className='description-1'>
                        <h1 className='title-description-11'>Ballon Adidas</h1>
                        <p className='price-tag-50'>40,00 €</p>
            ...
            <div className='flex-40'>
                ...
                <div className='flex-image-1'>
                    <div className='section-zoom-1'>
                        ...
                        <h1 className='title-zoom-1'>Ballon de football doré</h1>
                        <p className='paragraph-zoom-1'>50,00 €</p>
                    </div>
                    <div className='section-zoom-2'>
                        <img src={Img85} alt="basket" className='img-zoom-2'></img>
                        <h1 className='title-zoom-2'>Ballon de foot - Crossover</h1>
                        <p className='paragraph-zoom-2'>20,00 €</p>
                    </div>
                    <div className='section-zoom-3'>
                        <img src={Img86} alt="basket" className='img-zoom-3'></img>
                        <h1 className='title-zoom-3'>Maillot de foot</h1>
                        <p className='paragraph-zoom-3'>10,00 €</p>
                    </div>
                </div>
            </div>
        </div>
