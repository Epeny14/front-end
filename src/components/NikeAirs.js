            ...
            <div className='section-description'>
                <div className='flex-11'>
                    ...
                    <div className='description-1'>
                        <h1 className='title-description-11'>Nike Air React</h1>
                        <p className='price-tag-50'>50,30 €</p>
