            ...
            <div className='sections-2'>
                ...
                <div className='section-flex2'>
                    <div className='image-flex1'>
                        ...
                        <Link to="/football-homme" className='link-men'><h3 className='title-football-1'>Football</h3></Link>
                    </div>
                    <div className='image-flex2'>
                        <img src={Img32} alt='Basketball' className='basketball-men'></img>
                        <Link to="/basketball-homme" className='link-men'><h3 className='title-basketball-2'>Basketball</h3></Link>
                    </div>
                    <div className='image-flex3'>
                        <img src={Img33} alt='Tennis' className='tennis-men'></img>
                        <Link to="/tennis-homme" className='link-men'><h3 className='title-tennis-3'>Tennis</h3></Link>
                    </div>
